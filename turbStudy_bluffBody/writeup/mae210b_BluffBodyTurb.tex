...
\title{Review of Incompressible, Turbulent Bluff-Body Wakes and Analysis and Modeling Techniques for These Flows}
...
$D$     & Diameter as reference length\\
...
% \lettrine{B}{luff-bodies} (equivalently known as blunt-bodies) are a fundamental, generic body shape in aerodynamics, and they are classified as bodies where pressure drag makes up the majority of
...
% \begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\textwidth]{Images/logan/bluntVSstreamline.png}
\caption{ Demonstration of the flow differences between a bluff-body with massive separation \cite{richards2015modelling} and a streamlined body with primarily attached flow }
