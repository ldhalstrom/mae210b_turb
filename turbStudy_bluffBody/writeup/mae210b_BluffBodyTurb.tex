...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\textwidth]{Images/logan/yuan2017investigation_TacomaNarrowsWake.pdf}
\caption{ PIV flow field of bride model similar to tacoma narrows bridge Re=587 \cite{yuan2017investigation} }
...
Fig. 11. Instantaneous flow fields around the dynamic model. The corresponding inflow velocities are 0.66 m/s, 0.95 m/s, 1.14 m/s and 1.80 m/s for V1, T1, V2 and
T2.

Wake-induced vibration commences in V1 when the shear layer rolls up and
the Karman vortex street forms in the central gap
