...
\caption{Kárman-Bénard eddy street at $\textbf{Re=100}$. Extracted from \cite{Zdravkovich1968} }
\label{fig:sasvsuranscylinder}
\end{center}
\end{figure}
...
\caption{ Orion capsule mach number instantaneous (left) time-averaged (right) (DES, M=0.5) \cite{schwing2015detachededdy} }
\label{fig:orionflow}
\end{center}
\end{figure}
%%\vspace{-2em}
